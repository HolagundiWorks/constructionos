...
- **WinUI 3 replatform** (Windows-only, C#/.NET, **stock Fluent only**) — approved
  ...
  (u0.14)**. Specs: `docs/WINUI3-MIGRATION.md`,
...
- **Two environments:**
  - **Cloud (this agent):** domain / API / tests / docs. Cloud CT backlog
    **closed** (ROADMAP §1.3); u0.13–u0.14 closed cloud P0–P3 APIs + Foundry
    multi-agent Phase A.
  - **Local (Windows):** WinUI workflow depth (ROADMAP §2), MSIX release
    signing, sidecars/weights, tkinter smoke.

## Watch out
- **Flat ~196-module namespace** — `lessons.py` (rate realisation) ≠
...
- Catalog: **8 sections / 52 modules**; API **u0.14**. Headline counts (verify
  before quoting): **196** modules / **133** AST-pure / **85** tables / **61**
  indexes / **744** tests (5 skipped headless).
