...
def _company(company_name):
    """Escaped firm/software name for letterheads (falls back to ACO)."""
    return _text(company_name or branding.APP_NAME)


def _powered():
    """Escaped software credit line for document footers."""
    return _text(branding.POWERED_BY)
...
<div class="foot">{powered}<br>Generated by {company} on {generated}. Quantities from the
...
<div class="foot">{powered}<br>Generated by {company} on {generated}. Figures are in the
...
<div class="foot">{powered}<br>Generated by {company} on {generated}. This is a
...
def letterhead_html(firm):
    ...
    """
    firm = firm or {}
    name = _text(firm.get('name') or branding.APP_NAME)
    lines = []
    if firm.get('address'):
...
{summary}
{bank}
<div class="foot">{powered}<br>Generated by {company} on {generated}.</div>
"""


def build_estimate_html(est, items=None, seller=None, company_name=None):
    ...
    return _ESTIMATE_TEMPLATE.format(
        logo=_logo_tag(),
        company=_company(seller.get('name') or company_name),
        powered=_powered(),
...
<div class="foot">{powered}<br>Generated by {company} on {generated}. Estimate only — not a
tax invoice.</div>
"""
...
def build_mb_html(contract=None, client=None, site=None, rows=None,
                  boq_items=None, company_name=None,
                  issues=None):
